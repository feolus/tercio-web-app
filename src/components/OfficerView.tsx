...
type MainTab = 'my_equipment' | 'my_troops' | 'battle_plan' | 'war_orders';
...
const OfficerView: React.FC = () => {
    ...
    return (
        <div>
             <SectionHeader 
                title="Panel del Oficial" 
                description="Gestiona tu equipo personal y prepara las órdenes de guerra." 
            />
