...
type MainTab = 'my_equipment' | 'my_troops' | 'war_orders' | 'staff';
...
const DrillmasterView: React.FC = () => {
    ...
    return (
        <div>
             <SectionHeader 
                title="Panel del Sargento de Levas" 
                description="Gestiona tu equipo, tropas y la plana mayor de caballeros." 
            />
...
export default DrillmasterView;